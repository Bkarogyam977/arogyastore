...
export default function EnquiryForm() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 md:py-32   px-4 sm:px-6 lg:px-8">
      <Head>
        <title>Treatment Enquiry</title>
        <meta name="description" content="Enquire about AKRT Treatment" />
      </Head>

      <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
        <div className="p-8">
          <div className="text-center mb-6">
            <h1 className="text-2xl font-bold text-gray-800">Treatment Enquiry</h1>
