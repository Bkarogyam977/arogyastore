...
// const PopularLabTestsAndProfiles = () => {
...
//         <h2 className="text-xl font-bold text-gray-800">Popular Lab Tests & Profiles</h2>
//         <Link href="/#">
...
// export default PopularLabTestsAndProfiles;
...
const PopularLabTestsAndProfiles = () => {
  // Static data for popular lab tests
  const packages = [
    {
      id: 1,
      name: 'Advanced Full Body Checkup',
  ...
  return (
    <div className="w-full p-4 md:p-6 bg-white rounded-lg shadow-sm">
      ...
      <div className="flex justify-between items-center mb-4 md:mb-6">
        <h2 className="text-xl md:text-2xl font-bold text-gray-800">Popular Lab Tests & Profiles</h2>
        <Link href="/lab-tests">
