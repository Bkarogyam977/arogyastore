...
const page = ({ params }) => {
  return (
    <div>
      <RegisterPage referal={params.referal} />
  ...
  const iconurldata = [
    {
      ...
      iconUrl: "/images/medical-doctor--v4.png",
      quantity: "11723",
  ...
  const AccordianData = [
    {
      ...
      "data": "Yes, as a Nirog Partner Plus member Doctors do get patient's leads from NirogStreet's side"
    },
    {
      "header": " How does the payout work ",
      "data": "NS makes a payout against delivered orders every week to the Partner Doctors"
    },
    {
      "header": " Does NS charge consultation from Patients? ",
  ...
  return (
    <section className=' relative  ' style={{ overflowX: "clip" }}>
            ...
            <div className='absolute h-full inset-y-auto z-20 '>
              <div className='flex flex-col h-[50vh] md:h-full  justify-center px-3 ml-2 pl-4'>
                ...
                <div className=' md:text-2xl md:w-1/2'>
                  Access our world class solutions specifically designed for Vaidyas
                </div>
      ...
      <section>
        ...
        <div className='text-center w-full mx-auto font-bold text-2xl p-2'>
          Trusted by experienced doctors
        </div>

        <DoctorsComponent />
      </section>
      <section className='my-4 mb-[100px] md:mt-3 p-2'>
...
const ExclusiveOffer = () => {
  ...
  return (
    <section className='mx-auto'>
      ...
      <div className='flex  text-3xl justify-center font-bold text-center m-[1.5rem] p-2'>
      ...
      <section>
        <div className='flex mx-auto'>
          <div className=' text-2xl px-2 text-center flex mx-auto font-bold'>
            Become a Arogya Partner has many advantage for Vaidays
          </div>
...
export function SvgLineWithGola(props) {
  return (
    <>
      ...
      {/* <svg className=" stroke-gray-300" width="224" height="180"><line x1="0" y1="0" x2="224" y2="180" style="stroke-width: 2;"></line></svg> */}
    </>
  )
}
