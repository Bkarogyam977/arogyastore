...
const PainPage = () => {
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-[#acc5f8] text-center py-20 md:py-32">
        <h1 className="text-3xl md:text-5xl md:pt-12 px-4 font-bold text-gray-500">
          Feeling Pain Take Cure – With
          <span className="text-red-500"> &quot;OrthoVeda&quot;</span>
        </h1>
      </section>
      ...
      <section className="py-4">
        ...
        <OurSegment parentId={296} />
      </section>

      {/* Image Banner Section */}
      <section className="py-4 md:hidden">
        <Image
          src="/images/imageBox/OrthoVeda_P.png"
      ...
      <section className="py-4 hidden md:block">
        <Image
          src="/images/imageBox/banner/BKOrtho_Banner.jpg"
          alt="Heart Care Banner"
          className="w-full h-30 object-cover"
          width={800}
          height={120}
      ...
      <section className="py-4">
        ...
        <ProductSlider categoryId={444} />
      </section>

      {/* Diet Chart Section */}
      <section className="py-16 text-center hidden md:block">
        <Image
          src="/images/imageBox/hopes/Diet-Banner-Paim.png"
        ...
        />
        <a
          href="/files/Pain-care-diet-chart.pdf"
          download
      ...
      <section className="py-16 text-center  md:hidden">
        <Image
          src="/images/imageBox/DietChart-Pain.png"
          alt="Diet Chart Banner"
          width={500}
          height={300}
