...
const PainPage = () => {
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-[#39b0d1] text-center py-20 md:py-32">
        <h1 className="text-3xl md:text-5xl md:pt-12 px-4 font-bold text-gray-500">
          Take care of your kidey problem With
          <span className="text-red-500"> &quot;KidneyVeda&quot;</span>
        </h1>
      </section>
      ...
      <section className="py-4">
        ...
        <OurSegment parentId={300} />
      </section>

      {/* Image Banner Section */}
      <section className="py-4 md:hidden">
        <Image
          src="/images/imageBox/Kidneyveda_e.png"
      ...
      <section className="py-4 hidden md:block">
        <Image
          src="/images/imageBox/banner/BKKidney_Banner.jpg"
          alt="Heart Care Banner"
          className="w-full h-30 object-cover"
          width={800}
          height={120}
      ...
      <section className="py-4">
        ...
        <ProductSlider categoryId={455} />
      </section>

      {/* Diet Chart Section */}
      <section className="py-16 text-center hidden md:block">
        <Image
          src="/images/imageBox/banner/Diet-Banner-Kidney.png"
      ...
      <section className="py-16 text-center  md:hidden">
        ...
        >
          {" "}
          Download Pain Diet Chart <DownloadOutlined />
        </a>
      </section>
