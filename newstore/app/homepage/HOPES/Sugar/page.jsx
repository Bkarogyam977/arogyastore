...
const SugarPage = () => {
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-[#fbc37f] text-center py-20 md:py-32">
        <h1 className="text-3xl md:text-5xl md:pt-12 px-6 font-bold text-white">
          {" "}
          Take Control of your Diabetese With
          <span className="text-red-500"> &quot;GlucoVeda&quot;</span>
        </h1>
      </section>
      ...
      <section className="py-4">
        ...
        <OurSegment parentId={297} />
      </section>

      {/* Image Banner Section */}
      <section className="py-4 md:hidden">
        <Image
          src="/images/imageBox/Glucoveda atta.png"
      ...
      <section className="py-4 hidden md:block">
        <Image
          src="/images/imageBox/banner/BKGluco_Banner.jpg"
          alt="Heart Care Banner"
          className="w-full h-30 object-cover"
          width={800}
          height={120}
      ...
      <section className="py-4">
        ...
        <ProductSlider categoryId={437} />
      </section>

      {/* Diet Chart Section */}
      <section className="py-16 text-center hidden md:block">
        <Image
          src="/images/imageBox/hopes/Diet-Banner-Sugar.png"
        ...
        />
        <a
          href="/files/Diabetese-care-diet-chart.pdf"
          download
      ...
      <section className="py-16 text-center  md:hidden">
        <Image
          src="/images/imageBox/DietChart-Sugar.png"
          alt="Diet Chart Banner"
          width={500}
          height={300}
