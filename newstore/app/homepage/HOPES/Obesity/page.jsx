...
const ObesityPage = () => {
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-[#f7b4fb] text-center py-20 md:py-32">
        <h1 className="text-3xl md:text-5xl md:pt-12 px-4 font-bold text-gray-500">
          Shed the Weight, Gain the Life – With
          <span className="text-red-500"> &quot;SlimVeda&quot;</span>
        </h1>
      </section>

      {/* Our Segment Section */}
      <section className="py-4">
        <h2 className="text-2xl md:text-4xl font-semibold px-6 mb-2 md:mb-8 text-green-600 text-center">
          Our Segments
        </h2>
        <OurSegment parentId={298} />
      </section>

      {/* Image Banner Section */}
      <section className="py-4 md:hidden">
        <Image
          src="/images/imageBox/Slimveda_o.png"
      ...
      <section className="py-4 hidden md:block">
        <Image
          src="/images/imageBox/banner/BKSlim_Banner.jpg"
          alt="Heart Care Banner"
          className="w-full h-30 object-cover"
          width={800}
          height={120}
      ...
      {/* Product Section */}
      <section className="py-4">
        <h2 className="text-2xl md:text-3xl font-semibold px-6 mb-2 md:mb-8 text-green-600">
          Our Products
        </h2>
        <ProductSlider categoryId={443} />
      </section>

      {/* Diet Chart Section */}
      <section className="py-16 text-center hidden md:block">
        <Image
          src="/images/imageBox/hopes/Diet-Banner-Obesity.png"
      ...
      <section className="py-4 md:hidden relative">
        <Image
          ...
          className="w-full h-30 object-cover"
        />
        <div className="absolute inset-x-0 bottom-0 p-16 text-center bg-gradient-to-t from-black/50 to-transparent">
          <h3 className="text-green-700 text-3xl font-bold mb-10">
            Consult With Expert
          </h3>
      ...
      {/* Product Section */}
      <section className="py-4">
        <h2 className="text-2xl md:text-4xl  text-center font-semibold px-6 mb-2 md:mb-8 text-green-600">
          Our Products
        </h2>
        <ProductSlider categoryId={443} />
      </section>
          ...
          <div className="bg-gradient-to-r from-sky-500 to-sky-600 rounded-xl shadow-xl p-6 md:p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 md:grid-rows-2 gap-4 md:gap-6">
              ...
              <div className="bg-white rounded-xl shadow-md flex items-center justify-center p-4 md:p-6 text-center row-span-1 md:row-span-2 col-span-2 md:col-span-1 hover:transform hover:-translate-y-1 transition-transform duration-300">
                <div>
                  <p className="font-semibold text-base md:text-xl lg:text-2xl">
                    6 Lakh+ Happy Patients
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md flex items-center justify-center p-4 md:p-6 text-center col-span-2 hover:transform hover:-translate-y-1 transition-transform duration-300">
                <div>
                  <p className="font-semibold text-base md:text-xl lg:text-2xl">
                    बिना सर्जरी प्राकृतिक समाधान
                  </p>
                  <p className="text-gray-600 text-sm md:text-base mt-2">
                    Natural Solution Without Surgery
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="order-1 md:order-none text-center md:text-left mb-6 md:mb-0 md:mr-8">
          ...
          <p className="text-green-100 mb-6 md:mb-4 max-w-lg mx-auto md:mx-0">
            Get personalized treatment plans from experienced doctors
