            ...
            <section className="bg-gray-100 py-12" id="franchise-testimonials">
                <div className="container mx-auto px-4 md:px-16">
                    ...
                    <div className="bg-green-200 rounded-lg shadow-lg p-6 flex-shrink-0 w-80">
                        ...
                        “Partnering with ArogyaBharat has been a life-changing experience. The proven Ayurvedic treatments and support system helped me build a successful Arogya Point my city. Patients trust the brand, and so do I!”
                        </p>
                    </div>
                    ...
                    <div className="bg-green-200 rounded-lg shadow-lg p-6 flex-shrink-0 w-80">
                        ...
                        <p className="text-gray-700 text-sm">
                        “ArogyaBharat`&apos;`s Arogya Hub model provided me with everything I needed to start my Arogya Point. From operational guidance to marketing materials, their support has been exceptional.”
                        </p>
                    </div>
                            ...
                            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl">
                                <ul className="space-y-4 text-teal-50">
                                    ...
                                    <li className="flex items-start gap-3">
                                        ...
                                        <span>
                                            Existing Clinics/Hospitals wanting to add Ayurvedic services
                                        </span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <svg className="flex-shrink-0 w-5 h-5 text-teal-300 mt-1" fill="currentColor" viewBox="0 0 20 20">
