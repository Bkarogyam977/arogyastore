import { BankOutlined, CaretDownOutlined, CheckOutlined, EnvironmentOutlined, FlagOutlined, GlobalOutlined, HomeOutlined, MobileOutlined, PlusCircleFilled, TagOutlined, UserOutlined } from '@ant-design/icons'
import { Button, Checkbox, Form, Input, Select } from 'antd'
import React from 'react'

export const NewAddressFormSimple = ({onSubmit,country=[]}) => {
  return (
