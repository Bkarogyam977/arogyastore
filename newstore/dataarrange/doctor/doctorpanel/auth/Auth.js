...
class Auth extends React.Component {
    ...
    render() {
        const LoginFormLayout = Form.useForm(LoginForm);
        const PasswordResetForm = Form.useForm(DynamicFieldsForm);
        const LoginWithPhoneLayout = Form.useForm(LoginWithPhone);
