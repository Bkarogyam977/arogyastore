...
import {IMAGE_BASE_URL} from "../../dataarrange/config/connect";
...
export const makeFileURL = function (URL) {
    return `${'https://healdiway.bkarogyam.com'}/${URL}`;
}
...
export const postAPI = function (URL, dataToSend, successFn, errorFn, headerConfig = {}) {
    ...
    axios({
        ...
        data: dataToSend,
        headers: {
            Authorization: toke == undefined || toke == null ? '' : `Token ${getAuthToken()}`,
            ...headerConfig,
            ...extraHeaders
        }
    }).then(function (response) {
